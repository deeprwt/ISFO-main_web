...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div id="header" class="header section ">
                    ...
                    <div class="header-meta">
                            ...
                            <ul class="main-menu">
                                ...
                                <li><a href="#">About Us</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="{{ url('why-isfo') }}">Why ISFO Olympiad</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="#">More</a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ url('web/assets/pdf/AWARDS.pdf') }}" target="_blank">Awards</a></li>
                        ...
                        <div class="header-meta">
                            ...
                            <div class="header-login-join d-none d-lg-block">
                                ...
                                <a class="btn join-btn" href="{{ url('login') }}">Dashboard</a>
                            </div>
                            <!-- Header Login Join End -->
                        </div>
                        <!-- Header Meta End -->
            ...
            <div class="header bg-danger p-2">
            <div class="row w-100">
                <marquee behavior="scroll" direction="left" scrollamount="7" class="pt-1">
                <h4 class="text-white text-left" >
                Registrations Open. Last date of Registration is 20th October 2022.
                 </h4>
                </marquee>
</div>
            </div>
            ...
            <div class="offcanvas-body">
                <div class="offcanvas-menu">
                    ...
                    <a class="btn join-btn" href="{{ url('login') }}">Registration</a>
                        ...
                        <li><a href="#">More</a>
                            <ul class="sub-menu">
                                <li><a href="{{ url('awards-rec') }}">Awards</a></li>
                                <!-- <li><a href="{{ url('web/assets/pdf/process21.pdf') }}" target="_blank">Online Exam Process</a></li> -->
                        ...
                        <div class="col-md-3 p-2">
                            ...
                            <ul class="text-white">
                              ...
                              <!--  <li><a href="#" class="hvr-float-shadow">Gallery</a></li>-->
                                <li><a href="{{ url('contact') }}" class="hvr-float-shadow">Contact</a></li>
   ...
   <li><a href="{{ url('faq') }}" class="hvr-float-shadow" >Frequently Asked Questions</a></li>
                ...
                <div class="footer-copyright">
                        <div class="text-center">
                            <p>&copy;  Copyright 2022 Eupheus Learning | All Rights Reserved.. </p>
                        </div>
                </div>
                <!-- Footer Copyright End -->
            </div>
