                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="page-banner text-center">
                                    <h2 class="title " style="color:#1F3F6D;">Science Olympaid</h2>
                                    <ul class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item text-white"><a href="{{ url('/') }}" class="">Home</a></li>
                                        <li class="breadcrumb-item active text-white" aria-current="page">Science Olympaid</li>
                                    </ul>
                                </div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-4">
                                          <div class="text-center">
                                              <img src="{{ url('web/assets/images/olympaid/science.png') }}" alt="">
                                          </div>
                                      </div>
                                  </div>
                                </div>
