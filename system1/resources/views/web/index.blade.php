...
<!-- Features Four Start -->
<div class="section features-4-section pb-5">
    <div class="container">
        <!-- Features Four Wrapper Start -->
        <div class="features-4-wrapper p-4">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-4 text-center col-md-6 col-sm-6">
                        ...
                        <div style="width:300px;display:inline-block"  class="single-team ">
                            <div class="team-img">
                                <a href="{{ url('gallery') }}"><img src="{{ url('web/assets/images/img/pic2.jpg') }}" alt="team"></a>
                               
                            </div>
                            <div class="" style="height: 150px">
                                <div class="py-2 ">
                                    <h4 class="name"><a href="{{ url('gallery') }}" class="font-weight-bold mt-2" >EXAM SCHEDULE </a></h4>
                                </div>
                                
                                <div class="text-center">
                                    <a href="{{ url('gallery') }}" target="_blank" class="btn btn-warning rounded-lgx ">Read More</a>
                                 </div>
                            </div>
                    ...
                    <div class="col-lg-4 text-center col-md-6 col-sm-6">
                        ...
                        <div style="width:300px;display:inline-block"  class="single-team team-color-2">
                            <div class="team-img">
                                <a href="{{ url('scheme/gk') }}"><img src="{{ url('web/assets/images/img/pic4.jpg') }}" alt="team"></a>
                            
                            </div>
                            <div class="" style="height: 150px">
                                <div class="py-2 ">
                                    <h4 class="name"><a href="{{ url('scheme/gk') }}" target="_blank" class="font-weight-bold mt-2">TEST PAPER SCHEME & MARKING</a></h4>
                                </div>
                    ...
                    <div class="col-lg-4 text-center col-md-6 col-sm-6">
                        ...
                        <div style="width:300px;display:inline-block"  class="single-team">
                            <div class="team-img">
                                <a href="{{ url('web/assets/pdf/AWARDS.pdf') }}"><img src="{{ url('web/assets/images/img/pic1.jpg') }}" alt="team"></a>
                                
                            </div>

                            <div class="" style="height: 150px">
                                <div class="py-2 ">
                                    <h4 class="name"><a href="{{ url('web/assets/pdf/AWARDS.pdf') }}" target="_blank" class="font-weight-bold mt-2">Awards & Recognition</a></h4>
                                </div>
